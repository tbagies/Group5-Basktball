...
namespace Gestures
{
    class BouncingGesture
    {
        ...
        public BouncingGesture()
        {
            BounceingSegment1 bouncing0 = new BounceingSegment1();
            BouncingSegment2 bouncing1 = new BouncingSegment2();
